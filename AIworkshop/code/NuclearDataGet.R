...
twitter_token <- create_token(
  consumer_key = '8PH32Cydlc8xP1S9tLyb1BQQn',
  consumer_secret = '8qJI4VBmkEqZ1XyEkfYlhDMRrVf8PjVMQS7buI75ySITWwmJ62',
  access_token = '1330488273374900224-E7ck3XoV2lwf0tB2THkuHTc4sXCEgX',
  access_secret = 'y9n20n3lwlb6jGCBhn7dWKWf9ptZrsakeqDZTLLSzMi2x',
  set_renv = TRUE)


#James_tweets <- get_timeline("@ttggd5", n= 10000, lang ="en")

JapanNuclearWater <- search_tweets("#", n = 3000, include_rts = FALSE, lang ="en")
JapanNuclearWater
Fukushima <- search_tweets("#Japannuclearwastewater", n = 7000, include_rts = FALSE, lang ="en")
Fukushima
#dataframe rowdata

Fukushima <- data.frame(Fukushima$user_id, Fukushima$created_at,
                                         Fukushima$screen_name, Fukushima$text, 
                                         Fukushima$location)

write.csv(Fukushima, '../data/Japannuclearwastewater.csv', row.names = FALSE, fileEncoding = "UTF-8")
...
#James_tweets
James_tweets_organic <- read.csv('../data/Twitter/twitter.csv')
